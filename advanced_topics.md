...
| Topic | Why Study | Resources |
| --- | --- | --- |
| Digital Corpora, APIs, and Full-Text Mining | Teaches algorithmic text retrieval, automated regular-expression parsing, and programmatic access to historical databases. | Donald Sturgeon – *Unsupervised Extraction of Textual Reuse in Early Chinese Texts* (Digital Scholarship in the Humanities)<br>- [Chinese Text Project API & Text Tools](https://ctext.org/tools)<br>- [Academia Sinica: Scripta Sinica Database](https://ihp.sinica.edu.tw/) |
| Intertextuality, Stylometry, and Authorship Attribution | Uses statistical and machine-learning models to measure vocabulary distributions, detect hidden textual reuse, and evaluate disputed authorship in pre-modern texts. | Donald Sturgeon – *Digital Approaches to Text Reuse in Pre-modern Chinese* (Journal of Chinese History)<br>- Mark Ravina – *Intertextual Network Analysis of Premodern Japanese and Chinese Corpora* |
